...
CREATE TABLE signoz_metrics.distributed_time_series_v4 AS signoz_metrics.time_series_v4
...
CREATE TABLE signoz_metrics.distributed_samples_v4 AS signoz_metrics.samples_v4
ENGINE = Distributed('cluster', 'signoz_metrics', 'samples_v4', rand());

-- Exemplars table (local)
CREATE TABLE signoz_metrics.exemplars_v4 (
    env String,
    metric_name String,
    fingerprint UInt64,
    unix_milli Int64,
...
CREATE TABLE signoz_metrics.distributed_exemplars_v4 AS signoz_metrics.exemplars_v4
